...
polls_df <- read_csv("~/Documents/R-Projects/election-blog/Labs/Lab 6/house_polls_long.csv")
polls_df <- polls_df %>%
...
polls_df <- read_csv("~/Dropbox/ElectionAnalytics_Midterms/Lab sessions/fundamentals II_ incumbency/fips_district_polls_2018-2022.csv")
